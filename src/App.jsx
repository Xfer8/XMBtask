...
export default function App() {
  ...
  return (
    <div style={{ display: "flex", justifyContent: "center", minHeight: "100vh", backgroundColor: "#2A2A2A" }}>
      <div style={{ width: "100%", maxWidth: "640px", minWidth: "640px", display: "flex", flexDirection: "column", color: "white", border: "2px solid rgba(74, 222, 128, 0.5)" }}>
        {/* Persistent title bar */}
        <div style={{ padding: "20px 50px", display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1px solid #444" }}>
