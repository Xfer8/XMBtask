...
export default function App() {
  ...
  return (
    <div style={{ display: "flex", justifyContent: "center", minHeight: "100vh", backgroundColor: "#2e303a" }}>
      <div style={{ width: "100%", maxWidth: "640px", minWidth: "640px", display: "flex", flexDirection: "column", color: "white", boxSizing: "border-box" }}>
        {/* Persistent title bar */}
        <div style={{ padding: "8px 12px", display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: "1px solid #444", boxSizing: "border-box", width: "100%" }}>
